// @ts-check
// imported from http://countly.github.io/countly-server/api/utils_random-sfc32.js.html
 ...
 * @returns {() => number} - Returns prng instance
 */
export function sfc32(key) {
    /**
     ...
     * @returns {() => number} - Seed sramble function
     */
    function xfnv1a(str) {
